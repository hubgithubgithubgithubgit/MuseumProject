			...
			switch (input1) {
				...
				case 1 -> {
					if (!hasLoggedIn) {
						...
						if (guideBook.checkUser(email1) && guideBook.getUser(email1).getPassword().equals(password1)) {
				...
				case 5 -> {
					if (!hasLoggedIn) {
						...
						System.out.println("Press 4 Illusions Museum ticket");
						System.out.println();
						int input2 = sc.nextInt();
						switch (input2) {
							case 1 -> museumType = MuseumType.ARTS;
							case 2 -> museumType = MuseumType.HISTORY;
							case 3 -> museumType = MuseumType.ARCHAEOLOGY;
							case 4 -> museumType = MuseumType.ILLUSIONS;
							default -> {
						...
						switch (input3) {
							case 1 -> ticketType = TicketType.ADULT;
							case 2 -> ticketType = TicketType.CHILD;
							default -> {
								System.out.println("Bad input!");
								System.out.println();
							}
